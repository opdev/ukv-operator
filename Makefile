...
# unum.cloud/ukv-operator-bundle:$VERSION and unum.cloud/ukv-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/itroyano/ukv-operator
...
IMG ?= quay.io/itroyano/ukv-operator:latest
